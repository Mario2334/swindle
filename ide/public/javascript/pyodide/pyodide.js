...
var languagePluginLoader = new Promise((resolve, reject) => {
    ...
    // way.
    var baseURL = self.languagePluginUrl || 'https://pyodide-build.s3.ap-south-1.amazonaws.com/';
    ...
    let wasmURL = `${local_file}pyodide.asm.wasm`;
    //Changing to local python extension
    let wasmPath = "";
    let Module = {};
    self.Module = Module;
    ...
    var postRunPromise = new Promise((resolve, reject) => {
        Module.postRun = () => {
            delete self.Module;
            fetch(`${local_file}packages.json`)
    ...
    const data_script_src = `javascript/pyodide/pyodide.asm.data.js`;
    loadScript(data_script_src, () => {
        const scriptSrc = `${local_file}pyodide.asm.js`;
        loadScript(scriptSrc, () => {
